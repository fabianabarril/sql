...
SELECT *
FROM vendor as v 
INNER JOIN vendor_booth_assignments as ba
...
SELECT
DISTINCT vendor_id,
COUNT(booth_number) as rent_times
...
SELECT c.customer_last_name, c.customer_first_name, ROUND(SUM(cp.quantity * cp.cost_to_customer_per_qty), 2) as total_spent
